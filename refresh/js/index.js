...
$(".header_right01").click(function(){
	...
	var my04Content ='<div class="swiper-slide"><ul class="orderList"><li class="firstLi"><span class="leftSpan">2017-02-10 15:30</span><span class="rightSpan">待确定&nbsp;<a class="rightIcon" href="#"><i class="iconfont icon-xiangyou" style="font-size: 0.5rem;color:#BFBFBF;"></i></a></span></li><li class="secondLi"><ol class="showAdressOl"><li><a class="leftIcon" href="#"><i class="iconfont icon-qidian" style="font-size: 0.7rem;color:#00a05a;"></i></a><span class="rightSpan">中国中国中国中国减</span></li><li><a class="leftIcon" href="#"><i class="iconfont icon-zhongdian" style="font-size: 0.7rem;color:#e60032;"></i></a><span class="rightSpan">中国中国中国中国减</span></li></ol></li></ul></div>';
...
$(".showTab01 li a").each(function(index){
	$(this).click(function(){
		...
		if(index == 1){
			 var sss = '<div class="swiper-slide"><ul class="orderList"><li class="firstLi"><span class="leftSpan">2017-02-10 15:30</span><span class="rightSpan">待接单&nbsp;<a class="rightIcon" href="#"><i class="iconfont icon-xiangyou" style="font-size: 0.5rem;color:#BFBFBF;"></i></a></span></li><li class="secondLi"><ol class="showAdressOl"><li><a class="leftIcon" href="#"><i class="iconfont icon-qidian" style="font-size: 0.7rem;color:#00a05a;"></i></a><span class="rightSpan">中国中国中国中国减</span></li><li><a class="leftIcon" href="#"><i class="iconfont icon-zhongdian" style="font-size: 0.7rem;color:#e60032;"></i></a><span class="rightSpan">中国中国中国中国减</span></li></ol></li></ul></div>';
...
var my01Content = '<div class="swiper-slide"><ul class="orderList"><li class="firstLi"><span class="leftSpan">2017-02-10 15:30</span><span class="rightSpan">待接单&nbsp;<a class="rightIcon" href="#"><i class="iconfont icon-xiangyou" style="font-size: 0.5rem;color:#BFBFBF;"></i></a></span></li><li class="secondLi"><ol class="showAdressOl"><li><a class="leftIcon" href="#"><i class="iconfont icon-qidian" style="font-size: 0.7rem;color:#00a05a;"></i></a><span class="rightSpan">中国中国中国中国减</span></li><li><a class="leftIcon" href="#"><i class="iconfont icon-zhongdian" style="font-size: 0.7rem;color:#e60032;"></i></a><span class="rightSpan">中国中国中国中国减</span></li></ol></li></ul></div>';
